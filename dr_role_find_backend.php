...
$stmt = $pdo->prepare( "SELECT * FROM `doctor_tbls` WHERE `english_sirname` LIKE :english_sirname OR `english_firstname` LIKE :english_sirname ORDER BY `english_sirname` ASC;" );

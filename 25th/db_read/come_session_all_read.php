...
<?= $latest ?>
	...
	<div class="container">
		...
		<h5 class="text-center bo">クリックで詳細</h5>
		<div class="row">
			<div class="col-lg-11">
				<!--ここから ラジアルアカデミー -->
							...
							<form method="post" action="comedical_sessions.php">
								<button type="submit" class="mini_lecture" name="sessionNo" value="8">
									<div>
										...
										<div>コメンテーター:
											<?= _Q(makeComeList2017($pdo, 8, 2, 'com', $this_year)); ?>
										</div>										
										<div>内容:
				...
				<div class="session_title">
					...
					<!--
						...
						<button type="submit" class="mini_lecture" name="sessionNo" value="12">
							<div class="text-center">ポスターセッション審査結果発表  : 遠山　愼一<br><br>皆様方　今年もご苦労様でした　安全に家路につき、そして良いクリスマスとお正月をお迎え下さい　来年もお会いしましょう
							</div>
						</button>
					</div>
				</div>

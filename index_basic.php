...
charSetUTF8();
header('Location: https://www.kamakuralive.net/index.php');	//何故かこれでコピーページに飛ばさないと javascriptや cssが働かない
//接続
try {
	// MySQLサーバへ接続
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="2017top_main.css">
</head>
...
<body>
				...
				<ul class="nav nav-pills">
					<li class="dropdown col-xs-2 text-center"> <a href="#" class="dropdown-toggle li-white" data-toggle="dropdown"><span class="glyphicon glyphicon-home navigation_icon"></span></a>
						...
						<ul class="dropdown-menu">
							...
							<li class="divider"></li>
							<li><a href="2017planning/introduction2017.html">Introduction</a>
							</li>
							<li><a href="dr_role_find.php">Find your role <i class="glyphicon glyphicon-search"></i></a>
							</li>
							<li><a href="comecome2017/2017comecome.pdf">コメコメ演題募集</a>
							</li>
					...
					<li class="dropdown col-xs-2 text-center"><a href="#" class="dropdown-toggle li-white" data-toggle="dropdown"><span class="glyphicon glyphicon-exclamation-sign navigation_icon"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="administration/evt_roles_overview.php">ZAGAKU Overview</a>
							</li>
					...
					<li class="dropdown col-xs-2 text-center"><a href="#" class="dropdown-toggle li-white" data-toggle="dropdown"><span class="glyphicon glyphicon-search navigation_icon"></span></a>
						<ul class="dropdown-menu dropdown-menu-right">
							<p>&nbsp;Find your role!</p>
							<li><a class="btn-warning btn-lg" role="button" href="dr_role_find.php">Find your role <i class="glyphicon glyphicon-search"></i></a>
							</li>
						</ul>
					</li>
	...
	<div class="container">
		<div id="j-introduction">
			<h5 class="title">2017年12月開催<span class="red_bold_sm"> 最終更新:
      <?= $latest ?>
      </span></h5>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="input-group">
						<a class="btn btn-success btn-sm" role="button" href="db_read/tri_session_all_read.php ">TRIライブ(09日)</a>
				...
				<div class="col-lg-10 back-sky-blue">
					...
					<p><img src="Logo/Logo2017_200.png" width="84" height="71" class="right_float"/>
					</p>
					<ol>
						<li>TRIセッション
						</li>
					...
					<p>なお本HomePageは齋藤　滋自らがプログラミング知識を駆使して作り上げているものです　なかなかdatabaseの更新がおいついていませんので、内容は2017/09/14現在の段階で最新のものとはなっていません　順次リアルタイムに更新していきたいと思っております　僕の目指す型は、鎌倉ライブ実行委員会メンバー皆が構想を練り、それを Web上のデータベースに自ら反映してもらい、同時にそれが Web上に公開される、そのようなプログラミングを考えています　まだまだ不具合があるかも知れませんがご容赦下さい</p>
				</div>
				<div class="col-sm-12">
					<div class="input-group"></div><a class="btn btn-secondary btn-sm" role="button" href="https://conv.toptour.co.jp/shop/evt/KamakuraLive_2017/">事前登録(お得です!)</a> <a class="btn btn-primary btn-sm" role="button" href="dr_role_find.php">お仕事 <i class="glyphicon glyphicon-search"></i></a> <a class="btn btn-success  btn-sm openMidokoro" role="button">今年の見どころ　見てね! &raquo;</a> <a class="btn btn-danger btn-sm" role="button" href="2017FinalPDFProgram/2017FinalProgram.pdf">最終プログラムPDF</a>
					<a class="btn btn-info btn-sm" role="button" href="comecome2017/2017comecome.pdf">コメコメ演題受付中</a>
					<a class="btn btn-warning btn-sm" role="button" href="comecome2017/2017ComeCome_plan2017_09_07.pdf">コメコメプログラム概要</a>
				</div>
			</div>
		</div>

		<div id="e-introduction">
			<h5 class="title">December 2017<span class="red_bold_sm"> Last Update:
      <?= $latest ?>
    </h5>
			<h3 class="title">KAMAKURA LIVE 2017 <a class="btn btn-danger btn-sm jp" role="button" >日本語</a></h3>
			<div class="row">
				<div class="col-lg-12"> <a class="btn btn-success btn-sm" role="button" href="db_read/tri_session_all_read.php ">TRI Live (09th)</a>
				...
				<div class="col-sm-12"> <a class="btn btn-secondary btn-sm" role="button" href="https://conv.toptour.co.jp/shop/evt/KamakuraLive_2017/">Discount Preregistration</a> <a class="btn btn-primary btn-sm" role="button" href="dr_role_find.php">Find Your Role <i class="glyphicon glyphicon-search"></i></a> <a class="btn btn-success  btn-sm openMidokoro" role="button">What's interesting&raquo;</a> <a class="btn btn-danger btn-sm" role="button" href="2017FinalPDFProgram/2017FinalProgram.pdf">Final PDF Program</a>
					<a class="btn btn-info btn-sm" role="button" href="comecome2017/2017comecome.pdf">Wait for Your Submission</a>
					<a class="btn btn-warning btn-sm" role="button" href="comecome2017/2017ComeCome_plan2017_09_07.pdf">About ComeCome</a>
				</div>
			</div>
		</div>

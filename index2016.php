				...
				<ul class="nav nav-pills">
					<li class="dropdown"> <a href="#" class="dropdown-toggle li-white" data-toggle="dropdown"><span class="glyphicon glyphicon-calendar navigation_icon"></span><b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="23rd/db_read/tri_session_all_read.php">TRIライブ一日目</a>
							</li>
					...
					<li class="dropdown"> <a href="#" class="dropdown-toggle li-white" data-toggle="dropdown"><img src="23rd/Logo/2016reverse.jpg" width="35" height="30" alt=""/></a>

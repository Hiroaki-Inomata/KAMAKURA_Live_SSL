...
.pay1 {
    -webkit-animation: blink1 1.0s ease-in-out infinite alternate;
    -moz-animation: blink1 1.0s ease-in-out infinite alternate;
    animation: blink1 1.0s ease-in-out infinite alternate;
    color: white;
    font-weight: bold;
}
.pay2 {
...
<div class="container"><br>
  <ul class="nav nav-pills">
    <div class="btn-group">
    <button type="button" class="btn btn-primary dropdown-toggle btn-md mt-1 mr-1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">鎌倉ライブ2019ご案内</button>
    <div class="dropdown-menu"> <a class="dropdown-item" href="26th/db_read/tri_session_all_readJ.php#day1">TRIライブ一日目</a> <a class="dropdown-item" href="#">Welcome Party</a> <a class="dropdown-item" href="26th/db_read/tri_session_all_readJ.php#day2">TRIライブ二日目</a> <a class="dropdown-item" href="26th/db_read/zagaku_all_read.php">インタベ座学</a> <a class="dropdown-item" href="26th/db_read/com_session_all_read_renewed.php">コメディカル・セッション</a> <a class="dropdown-item" href="26th/dr_role_find.php">Find My Role <i class="glyphicon glyphicon-search"></i></a> <a class="dropdown-item" href="26th/comecome2018/2018comecome .pdf">コメコメ演題募集</a> </div>
    <div class="btn-group">
      <button type="button" class="btn btn-md pay mr-1" role="button" href="https://conv.toptour.co.jp/shop/evt/kamakuralive2019/"> 事前登録</button>
    </div>
    <div class="btn-group">
      <button type="button" class="btn btn-info dropdown-toggle btn-md mr-1 dropdown-menu-left" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">その他</button>
      <div class="dropdown-menu"> <a class="dropdown-item" href="26th/2019planning/introduction2019.html">Introduction</a> <a class="dropdown-item" href="26th/dr_role_find.php">Find My Role <i class="glyphicon glyphicon-search"></i></a> <a class="dropdown-item" href="26th/comecome2018/2018comecome .pdf">コメコメ演題募集</a> </div>
    </div>
  </ul>
</div>

<!-- Modal -->
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal1"> Launch demo modal </button>
<div class="modal fade" id="modal1" tabindex="-1"
      role="dialog" aria-labelledby="label1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="label1">Modal タイトル</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
      </div>
      <div class="modal-body"> Modal 内容 </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-color:yellowgreen;">
        <p style="font-weight:bold; color:red; font-size:large;"> 齋藤　滋の独り言<br>
        </p>
        <ol>
          <li>日本でTRIが開始されたのは、1996年のことでした。従って日本にTRIが開花してから 既に22年が経過しました</li>
          <p>この間にどこまでTRIが進化したか?</p>
          <li>齋藤　滋がPCIを始めたのは 1981年でした　ですから既に 37年間経過</li>
          <p>老体のグルが何処までできるか?</p>
          <li>化石のような術者による化石のようなPCIにどれだけのファンが集まるか?</li>
          <p>まずい　これで最後か???</p>
          <li>とは言っても今年もTAVIや MitraClipさらには次世代のSHDインターションに対しても、現役で前に進んでいます。今回もTRIについて力を振り絞り頑張りましょう</li>
          <li>また、2017年鎌倉ライブデで本格的に導入されたTRIの新しい潮流である、PPA (DRA)アプローチについてももっと知ることになると思います。</li>
          <p>皆さんご支援宜しくお願いします。</p>
        </ol>
      </div>
      <div class="modal-footer">
...
<div id="j-introduction">
  <h5 class="title">2019年12月14/15日開催<span class="red_bold_sm"> 最終更新:
    <?=$latest ?>
  </h5>
  </h5>
  <h3 class="title">鎌倉ライブ2019 <a class="btn btn-primary btn-sm eng" role="button">English</a> CVIT専門医認定医更新点数2点</h3>
  <div class="row">
    <div class="container-fluid"> 
      <!--
        <div class="input-group">
        <a class="btn btn-success btn-sm" role="button" href="#">TRIライブ(14日)</a> <a class="btn btn-default btn-sm" href="26th/db_read/zagaku_all_read.php">インタベ座学(14日)</a> <a class="btn btn-primary btn-sm" role="button" href="#">Welcome Party</a> <a class="btn btn-warning btn-sm" role="button" href="#">TRIライブ(15日)</a> <a class="btn btn-info btn-sm" role="button" href="26th/db_read/com_session_all_read_renewed.php">コメコメ(15日)</a> <a class="btn btn-warning btn-sm" role="button" href="#">Battle Talkアンケート</a>        
      </div>
		--> 
      <!--<div class="col-lg-10 back-sky-blue"> 
      <div class="col-lg-10 back-coral-orange"> -->
      <div class="container-fluid back-coral-orange" style="background-color:#E97963;">
        <p class="text-light"> 今年も毎年恒例の鎌倉ライブデモンストレーション・コースが開催される時となりました。昨年好評であった若手医師とコメディカルを対象としたインターベンション座学を併設させていただきますが、それ以外にも興味深い内容で盛りだくさんです。: </p>
        <p> 
        <a href="planner_only/index-mod.php"><img src="26th/Logo/Logo2018_200.png" width="84" height="71" class="right_float"/>
        <ul>
          ...
          <li class="text-light mt-2"><a class="btn btn-light btn-sm" role="button" href="26th/db_read/zagaku_all_read.php">KODOCU（蠱毒）(14日)</a> &nbsp;&nbsp; <a class="btn btn-danger btn-sm" role="button" href="#">最終プログラム</a> </li>
          <li class="text-light mt-2"><a class="btn btn-info btn-sm" role="button" href="26th/db_read/com_session_all_read_renewed.php">コメディカル・セッション (15日)</a>&nbsp;&nbsp;<a class="btn btn-primary btn-sm" role="button" href="26th/db_read/faculty_list.php">登場人物一覧</a> </li>
          <li class="text-light mt-2"><a class="btn btn-danger btn-sm" role="button" href="#">これでバッチリ OCT/FFRトレーニング・センター (14日、15日)</a>
            <p><img src="26th/logo2019/right_brown.jpg" width="85" height="82" class="right_float"/> </p>
          </li>
        </ul>
        <!-- <a class="btn btn-info btn-lg pay" role="button" href="26th/2018photos/Mt-Fuji.pdf">
					<h4>鎌倉ライブ2019は無事終了しました</h4></a> --> 
        <!--<a class="btn btn-danger btn-sm pay" role="button" href="#f">
					<h6>コメディカル・セッション・アンケート結果</h6></a>
					<a class="btn btn-danger btn-sm pay" role="button" href="#">
					<h6>ソロ社会セッション・アンケート結果</h6></a> -->
        <p class="text-light">皆様方　クリスマス・シーズンでイルミネーションのとても美しいこの横浜ベイエリアで開催されます、今年の 鎌倉ライブデモンストレーション・コースにふるってご参加下さい! </p>
        <p class="text-light">なお本HomePageは齋藤　滋自らがプログラミング知識を駆使して作り上げているものです。鎌倉ライブ実行委員会メンバーがライブデモンストレーションのプログラムについて皆で構想を練り、その内容が Web上のデータベースに逐次書き込まれ、それが Web上に公開される、そのようなプログラミングを行っています　不具合がありますればご容赦の上、ご指摘下さい</p>
      </div>
      <div class="col-sm-12">
        <div class="input-group"></div>
        <a class="btn btn-sm pay" role="button" href="https://conv.toptour.co.jp/shop/evt/kamakuralive2019/">事前登録</a> 
        <!--<div class="input-group"></div><a class="btn btn-lg pay" role="button" href="https://conv.toptour.co.jp/shop/evt/KamakuraLive_2018/">事前登録</a> --> 
        <a class="btn btn-primary btn-sm" role="button" href="26th/dr_role_find.php">私のお仕事</a> <a class="btn btn-success  btn-sm openMidokoro" role="button">今年の見どころ　見てね! &raquo;</a> <a class="btn btn-warning btn-sm" role="button" href="#">Luncheon Sessions</a> <a class="btn btn-danger btn-sm" role="button" href="#">Welcome Party</a> 
        <!--<a class="btn btn-info btn-sm" role="button" href="26th/comecome2018/2018comecome.pdf">コメコメ演題受付中</a>
					<a class="btn btn-info btn-sm" role="button" href="#">ソロ社会に関するアンケート</a>  --> 
      </div>
    </div>
  </div>
  <div id="e-introduction">
    <h5 class="title">December 14th and 15th, 2019<span class="red_bold_sm"> Last Update: 
      <!-- #BeginDate format:IS1 -->2019-10-20<!-- #EndDate -->
      <?php
				//echo $latest ?>
    </h5>
    <h3 class="title">KAMAKURA LIVE 2019 <a class="btn btn-danger btn-sm jp" role="button" >日本語</a></h3>
    <div class="row">
      <div class="col-lg-12"> <a class="btn btn-success btn-sm" role="button" href="26th/db_read/tri_session_all_readJ.php#day1">TRI Live (14th)</a> <a class="btn btn-default btn-swhich m" href="26th/db_read/zagaku_all_read.php">ZAGAKU (14th)</a> <a class="btn btn-primary btn-sm" role="button" href="26th/2018FinalPDFProgram/2018welcome_party.pdf">Welcome Party</a> <a class="btn btn-warning btn-sm" role="button" href="26th/db_read/tri_session_all_readJ.php#day2">TRI Live (15th)</a> <a class="btn btn-info btn-sm" role="button" href="26th/db_read/com_session_all_read.php">ComeCome (15th)</a> <a class="btn btn-danger btn-sm" role="button" href="26th/oct_training/index.php">OCT/FFR Traning Centger</a> </div>
      <div class="col-lg-10 back-faint-pink">
        <p> We are proud to announce that we will have KAMAKURA LIVE DEMONSTRATION COURESE 2019 this year as the past more than 20 years. This year, we will be back to our original mission, which is to promote transradial coronary intervention (TRI) all around the world. This year, the course consists of 3 parts:</p>
        <p><img src="26th/Logo/Logo2018_200.png" width="84" height="71" class="right_float"/> </p>
        <ol>
          <li>TRI Session </li>
          <li>Intervention Teaching Course </li>
          <li>Comedical Session </li>
        </ol>
      ...
      <div class="col-sm-12"> <a class="btn btn-default btn-sm" role="button" href="https://conv.toptour.co.jp/shop/evt/KamakuraLive_2018/">Discount Preregistration</a> <a class="btn btn-primary btn-sm" role="button" href="26th/dr_role_find.php">Find My Role <i class="glyphicon glyphicon-search"></i></a> <a class="btn btn-success  btn-sm openMidokoro" role="button">What's interesting&raquo;</a> <a class="btn btn-danger btn-sm" role="button" href="26th/2018FinalPDFProgram/pamphlet2018final.pdf">Final PDF Program</a> <a class="btn btn-info btn-sm" role="button" href="26th/comecome2018/2018comecome.pdf">Wait for Your Submission</a> <a class="btn btn-warning btn-sm" role="button" href="26th/comecome2018/2018comecome.pdf">About ComeCome</a> </div>
    </div>
  </div>
  <footer>

<script src="bootstrap-4.3.1-dist/js/jquery-3.4.1.min.js"></script><?php
session_start();
...
if ($latest < '2018-12-17 07:00:00') $latest = '2019-01-26 07:12:35';
...
<body>
				...
				<ul class="nav nav-pills">
					<li class="dropdown col-xs-2 text-center"> <a href="#" class="dropdown-toggle li-white" data-toggle="dropdown"><span class="glyphicon glyphicon-home navigation_icon"></span></a>
						...
						<ul class="dropdown-menu">
							<li><a href="25th/db_read/tri_session_all_readJ.php#day1">TRIライブ一日目</a>
							</li>
							<li><a href="#">Welcome Party</a>
							</li>
							<li><a href="25th/db_read/tri_session_all_readJ.php#day2">TRIライブ二日目</a>
							</li>
	...
	<div class="container">
		<div id="j-introduction">
			<h5 class="title">2018年12月15日と16日開催<span class="red_bold_sm"> 最終更新: <?= $latest ?>
      </span></h5>
			<h3 class="title">鎌倉ライブ2018 <a class="btn btn-primary btn-sm eng" role="button">English</a> CVIT専門医認定医更新点数2点</h3>
			<div class="row">
				<div class="col-lg-12">
					<div class="input-group"></div>
						<a class="btn btn-success btn-sm" role="button" href="25th/db_read/tri_session_all_readJ.php#day1">TRIライブ(15日)</a>
						...
						<a class="btn btn-warning btn-sm" role="button" href="25th/db_read/tri_session_all_readJ.php#day2">TRIライブ(16日)</a>
						<a class="btn btn-info btn-sm" role="button" href="25th/db_read/com_session_all_read_renewed.php">コメコメ(16日)</a>
						<a class="btn btn-warning btn-sm" role="button" href="25th/comecome2018/2018surveillance.pdf">Battle Talkアンケート</a>
					<!--</div> -->
				...
				<div class="col-lg-10 back-sky-blue">
					...
					<p><a href="planner_only/index-mod.php"><img src="25th/Logo/Logo2018_200.png" width="84" height="71" class="right_float"/></a>
						<a href="https://phazor.info/HorliX/"><img src="25th/Logo/HorliX.png" width="70" height="85" class="right_float"/></a>
					</p>
					<ol>
						<!--
						<li>TRIセッション&nbsp;&nbsp;<a class="btn btn-success btn-sm" role="button" href="25th/db_read/tri_session_all_readJ.php ">TRI Live (15th - DEC)</a> &nbsp;
							<a class="btn btn-warning btn-sm" role="button" href="25th/db_read/tri_session_all_readJ.php#day2 ">TRI Live (16th - DEC)</a>
						</li>
...
-->
						...
						<li>TRIセッション&nbsp;&nbsp;<a class="btn btn-success btn-sm" role="button" href="25th/db_read/tri_session_all_readJ.php#day1">TRI Live (15th - DEC)</a> &nbsp;<a class="btn btn-danger btn-sm" role="button" href="25th/2018posters/MiniLecture.pdf">Mini-Lectures</a>&nbsp;
							<a class="btn btn-warning btn-sm" role="button" href="25th/db_read/tri_session_all_readJ.php#day2">TRI Live (16th - DEC)</a>
						</li>
						<li>インターベンション座学&nbsp;&nbsp;<a class="btn btn-default btn-sm" role="button" href="25th/db_read/zagaku_all_read.php">インターベンション座学(15日)</a>
						</li>
						<li>コメディカル・セッション&nbsp;&nbsp;<a class="btn btn-info btn-sm" role="button" href="25th/db_read/com_session_all_read_renewed.php">コメディカル・セッション(16日)</a> &nbsp;&nbsp;
							<a class="btn btn-danger btn-lg" role="button" href="25th/2018posters/Final_Announcement_1206ALL.pdf">最終プログラム</a>
						</li>
						<li>OCT/FFRトレーニングセンター&nbsp;&nbsp;<a class="btn btn-danger btn-sm" role="button" href="25th/oct_training/index.php">これでバッチリ OCT/FFRトレーニング・センター (15日、16日)</a>&nbsp;&nbsp;<a class="btn btn-default btn-lg" role="button" href="25th/db_read/faculty_list.php">登場人物一覧</a>
							<p><img src="25th/Logo/face2018-1.png" width="85" height="85" class="right_float"/>
							</p>
						</li>
					</ol>
					<!-- <a class="btn btn-info btn-lg pay" role="button" href="25th/2018photos/Mt-Fuji.pdf">
					<h4>鎌倉ライブ2018は無事終了しました</h4></a> -->
					<a class="btn btn-danger btn-lg pay" role="button" href="25th/comecome2018/result_comecome.pdf">
					<h4>コメディカル・セッション・アンケート結果</h4></a>
					<a class="btn btn-danger btn-lg pay" role="button" href="25th/comecome2018/result_life.pdf">
					<h4>ソロ社会セッション・アンケート結果</h4></a>
					<p><br>皆様方　クリスマス・シーズンでイルミネーションのとても美しいこの横浜ベイエリアで開催されます、今年の 鎌倉ライブデモンストレーション・コースにふるってご参加下さい! </p>
				...
				<div class="col-sm-12">
					<div class="input-group"></div><a class="btn btn-sm" role="button" href="#">事前登録締め切りました</a>
					...
					<a class="btn btn-primary btn-sm" role="button" href="25th/dr_role_find.php">私のお仕事</a>
					<a class="btn btn-success  btn-sm openMidokoro" role="button">今年の見どころ　見てね! &raquo;</a>
					<a class="btn btn-warning btn-sm" role="button" href="25th/2018posters/Luncheons.pdf">Luncheon Sessions</a>
					<a class="btn btn-danger btn-sm" role="button" href="25th/2018posters/Welcome.pdf">Welcome Party</a>
					<!--<a class="btn btn-info btn-sm" role="button" href="25th/comecome2018/2018comecome.pdf">コメコメ演題受付中</a> -->
					<a class="btn btn-info btn-sm" role="button" href="25th/comecome2018/life_survey.pdf">ソロ社会に関するアンケート</a>
				</div>
			</div>
		</div>
      ...
      <?= $latest ?>
			...
			<div class="row">
				<div class="col-lg-12"> <a class="btn btn-success btn-sm" role="button" href="25th/db_read/tri_session_all_readJ.php ">TRI Live (15th)</a>
					...
					<a class="btn btn-warning btn-sm" role="button" href="25th/db_read/tri_session_all_readJ.php#day2">TRI Live (16th)</a>
